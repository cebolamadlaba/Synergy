...
namespace StandardBank.ConcessionManagement.BusinessLogic.Test.UnitTest
{
    ...
    public class LetterGeneratorManagerTest
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LetterGeneratorManagerTest"/> class.
        /// </summary>
        public LetterGeneratorManagerTest()
        {
            _letterGeneratorManager = new LetterGeneratorManager(InstantiatedDependencies.ConfigurationData,
        ...
        public void GenerateLetters_Lending_Executes_Positive()
        {
            ...
            var result = _letterGeneratorManager.GenerateLetters("L0001");
        ...
        public void GenerateLetters_Cash_Executes_Positive()
        {
            ...
            var result = _letterGeneratorManager.GenerateLetters("C0001");

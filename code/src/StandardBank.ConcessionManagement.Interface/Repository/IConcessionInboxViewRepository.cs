...
namespace StandardBank.ConcessionManagement.Interface.Repository
{
    ...
    public interface IConcessionInboxViewRepository
    {
        ...
        /// <param name="isActive">if set to <c>true</c> [is active].</param>
        /// <returns></returns>
        IEnumerable<ConcessionInboxView> ReadByRequestorIdBetweenStartExpiryDateEndExpiryDateIsActive(int requestorId,
        ...
        /// <param name="isActive">if set to <c>true</c> [is active].</param>
        /// <returns></returns>
        IEnumerable<ConcessionInboxView> ReadByRequestorIdIsMismatchedIsActive(int requestorId, bool isMismatched, bool isActive);

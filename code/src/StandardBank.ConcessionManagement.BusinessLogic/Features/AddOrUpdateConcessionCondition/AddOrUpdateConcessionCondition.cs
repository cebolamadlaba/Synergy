...
namespace StandardBank.ConcessionManagement.BusinessLogic.Features.AddOrUpdateConcessionCondition
{
    ...
    public class AddOrUpdateConcessionCondition : IRequest<ConcessionCondition>, IAuditableCommand
    {
        /// <summary>
        ...
        public AddOrUpdateConcessionCondition(ConcessionCondition concessionCondition, User user, Concession concession)
        {

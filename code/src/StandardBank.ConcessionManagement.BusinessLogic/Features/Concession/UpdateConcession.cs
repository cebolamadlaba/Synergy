...
namespace StandardBank.ConcessionManagement.BusinessLogic.Features.Concession
{
    ...
    public class UpdateConcession : IRequest<Model.UserInterface.Concession>, IAuditableCommand
    {
        /// <summary>
        ...
        public UpdateConcession(Model.UserInterface.Concession concession, User user)
        {
